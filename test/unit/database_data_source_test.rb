...
class DatabaseDataSourceTest < ActiveSupport::TestCase
  def setup
    @data_source = NysenateAuditUtils::Users::DatabaseDataSource.new
  end
  ...
  def test_search_returns_empty_array_when_no_matches
    results = @data_source.search('NonExistent', user_type: 'Vendor')
  ...
  def test_search_respects_limit
    ...
    results = @data_source.search('Test', user_type: 'Vendor', limit: 2)
  ...
  def test_search_respects_offset
    ...
    results = @data_source.search('Test', user_type: 'Vendor', offset: 2)
